...
bi.bi_bilan bilan,sv.sv_libelle service_libelle,ps.ps_nom,bi.bi_PAL PAL,bi.bi_BID BID,bi.bi_B1T B1T,bi.bi_CHO CHO,bi.bi_Fe Fe,bi.bi_Gly Gly,bi.bi_HDL HDL,bi.bi_LDL LDL,bi.bi_PRO PRO,bi.bi_PHO PHO,
...
FROM patient p 
 ...
 WHERE bi_dateprelevement BETWEEN :bi_dateprelevement_debut AND :bi_dateprelevement_fin');
 $req->execute(array('bi_dateprelevement_debut'=>$bi_date_debut,
 'bi_dateprelevement_fin'=>$bi_date_fin))
 or die(print_r($req->errorInfo()));
$handle=fopen('php://output', 'w');
//On insère les titres
fputcsv($handle,array('dossier','projet','pa_laboratoire','nom','prenom','sexe','age','bilan','service','prescripteur','PAL','BID','B1T','CHO','Fe','Gly','HDL','LDL','PRO','PHO',
...
header('Content-Disposition: attachment;filename=ectraction_bio.csv');
ob_flush();
?>
