...
gr.gr_bilan bilan,
ps.ps_nom prescripteur,gr.gr_proteine,gr.gr_test,gr.gr_glucose,gr.gr_leucocyte,gr.gr_hematie,sv.sv_libelle service_libelle,gr.gr_technique technique_libelle,
gr.gr_dateprelevement dateprelevement,gr.gr_daterendue date_rendue
 ...
 WHERE gr_dateprelevement BETWEEN :gr_dateprelevement_debut AND :gr_dateprelevement_fin');
...
header('Content-Disposition: attachment;filename=extraction_grossesse.csv');
ob_flush();
?>