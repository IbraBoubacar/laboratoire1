...
?>
<div class="col-md-10">
<form method="post" action='../modele/search_sero.php' class="col-md-12">
...
<form method="post" action='../modele/search_bio.php' class="col-md-12">
...
<form method="post" action='../modele/search_num.php' class="col-md-12">
...
<form method="post" action='../modele/search_cv.php' class="col-md-12">
...
<form method="post" action='../modele/search_gr.php' class="col-md-12">
