<?php
 ...
 ?><div class="input-group col-md-12">
...
</span>	<input type="text" name="sexe"  class="form-control" id="sexe" placeholder="<?php echo $_SESSION['pa_sexe']; ?>">
...
</span>	<input type="text" name="nationalite"  class="form-control" id="nationalite" placeholder="<?php echo $_SESSION['pa_nationalite']; ?>">
	...
	</span>	<input type="text" name="adresse"  style="width:520px" class="form-control" id="adresse" placeholder="<?php echo $_SESSION['pa_adresse']; ?>">
	<span  class="input-group-btn">
	<label for="service" class="btn btn-primary" style="width:65px"  type="button">Service
	</span>	<input type="text" name="bi_technique"  style="width:130px" class="form-control" id="service">
...
<span  class="input-group-btn">
	...
	</span>	<input type="text" name="prescripteur"  style="width:120px" class="form-control" id="prescripteur">
	<span  class="input-group-btn">
	<label for="service" class="btn btn-primary" style="width:65px"  type="button">Service
	</span>	<input type="text" name="service"  style="width:130px" class="form-control" id="service">
